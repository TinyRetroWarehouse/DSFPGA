...
-- program: branch to thumbroutine and return and skip 1 instruction then write PC and LR to memory
DSCPU_LOAD(0, 0)
DSCPU_LOAD(1, 5)
DSCPU_LOAD(1, 5)
...
write_dsbus_16bit(0xE803, 0x02000100)
...
compare_dsbus_32bit( 5, 0x00000000)
