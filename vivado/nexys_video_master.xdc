...
## DPTI/DSPI
#set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { ftdi_clko  }]; #IO_L13P_T2_MRCC_14 Sch=prog_clko
set_property -dict { PACKAGE_PIN U20   IOSTANDARD LVCMOS33 } [get_ports { ftdi_d[0]  }]; #IO_L11P_T1_SRCC_14 Sch=prog_d0/sck
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { ftdi_d[1]  }]; #IO_L19P_T3_A10_D26_14 Sch=prog_d1/mosi
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { ftdi_d[2]  }]; #IO_L22P_T3_A05_D21_14 Sch=prog_d2/miso
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { ftdi_d[3]  }]; #IO_L18P_T2_A12_D28_14 Sch=prog_d3/ss
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { ftdi_d[4]  }]; #IO_L24N_T3_A00_D16_14 Sch=prog_d[4]
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { ftdi_d[5]  }]; #IO_L24P_T3_A01_D17_14 Sch=prog_d[5]
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { ftdi_d[6]  }]; #IO_L20P_T3_A08_D24_14 Sch=prog_d[6]
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { ftdi_d[7]  }]; #IO_L23N_T3_A02_D18_14 Sch=prog_d[7]
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { ftdi_oen   }]; #IO_L16P_T2_CSI_B_14 Sch=prog_oen
set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS33 } [get_ports { ftdi_rdn   }]; #IO_L5P_T0_D06_14 Sch=prog_rdn
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { ftdi_rxen  }]; #IO_L21P_T3_DQS_14 Sch=prog_rxen
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { ftdi_siwun }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=prog_siwun
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { ftdi_spien }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=prog_spien
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { ftdi_txen  }]; #IO_L13N_T2_MRCC_14 Sch=prog_txen
set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports { ftdi_wrn   }]; #IO_L5N_T0_D07_14 Sch=prog_wrn
...
## timing
set_false_path -from [get_clocks -of_objects [get_pins iclk_wiz/inst/mmcm_adv_inst/CLKOUT0]] -to [get_clocks -of_objects [get_pins ihdmi_out/timing_hd720p.clock/clock/CLKOUT1]]
set_false_path -from [get_clocks -of_objects [get_pins imig_7series_0/u_mig_7series_0_mig/u_ddr3_infrastructure/gen_mmcm.mmcm_i/CLKFBOUT]] -to [get_clocks -of_objects [get_pins ihdmi_out/timing_hd720p.clock/clock/CLKOUT1]]

set_max_delay -from [get_pins {ids/ids_top/ids_cpu9/mul_op2_reg[31]/C}] -to [get_pins {ids/ids_top/ids_cpu9/mul_result_reg[*]/D}] 20.0
set_max_delay -from [get_pins {ids/ids_top/ids_cpu7/mul_op2_reg[31]/C}] -to [get_pins {ids/ids_top/ids_cpu7/mul_result_reg[*]/D}] 20.0

set_max_delay -from [get_pins ids/ids_top/ids_cpu9/execute_mul_signed_reg/C] -to [get_pins {ids/ids_top/ids_cpu9/mul_result_reg[*]/D}] 20.0
set_max_delay -from [get_pins ids/ids_top/ids_cpu7/execute_mul_signed_reg/C] -to [get_pins {ids/ids_top/ids_cpu7/mul_result_reg[*]/D}] 20.0

set_max_delay -from [get_pins ids/ids_top/ids_cpu9/execute_mul_long_reg/C] -to [get_pins {ids/ids_top/ids_cpu9/mul_result_reg[*]/D}] 20.0
set_max_delay -from [get_pins ids/ids_top/ids_cpu7/execute_mul_long_reg/C] -to [get_pins {ids/ids_top/ids_cpu7/mul_result_reg[*]/D}] 20.0

set_max_delay -to [get_pins {ids/ids_top/ids_cpu9/mul_result_reg[*]/D}] 20.0
set_max_delay -to [get_pins {ids/ids_top/ids_cpu7/mul_result_reg[*]/D}] 20.0